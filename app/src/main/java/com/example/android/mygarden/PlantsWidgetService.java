...
public class PlantsWidgetService extends RemoteViewsService {
    @Override
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new PlantsRemoteViewsFactory(this.getApplicationContext());
    }


}

class PlantsRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    Context mContext;
    Cursor mCursor;

    public PlantsRemoteViewsFactory(Context applicationContext) {
